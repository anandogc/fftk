...
namespace FFTK {
    ...
    void FFF::Forward_transform_2d(string basis_option, Array<Real,2> Ar, Array<Complex,2> A) {
     ...
     *
     */
    void FFF::Inverse_transform_2d(string basis_option, Array<Complex,2> A, Array<Real,2> Ar) {
